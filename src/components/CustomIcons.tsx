...
export function BioClockInLogo({
  size = 22,           
  weightLeft = 800,   
  weightRight = 500,      
}: {
  ...
  return (
    <Box sx={{ display: 'inline-flex', alignItems: 'center', gap: 1 }}>
      <FingerprintIcon sx={{ fontSize: size + 2 }} />
      <Typography
        component="span"
        sx={{ fontSize: size, fontWeight: weightLeft, lineHeight: 1 }}
      >
        BioClock
      </Typography>
      <Typography
        component="span"
        sx={{ fontSize: size, fontWeight: weightRight, lineHeight: 1 }}
      >-in
      </Typography>
    </Box>
  );
